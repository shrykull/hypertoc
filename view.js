 ...
 */
 ...
 function drawX(color, lineWidth, top, left, width, height) {
	canvasContext.beginPath();
	canvasContext.strokeStyle = color;
	canvasContext.lineWidth = lineWidth;
	
	canvasContext.moveTo(left, top);
	canvasContext.lineTo(left + width, top + height);
	
	canvasContext.moveTo(left + width, top);
	canvasContext.lineTo(left, top + height);
	
	canvasContext.stroke();
	canvasContext.closePath();
 }
 
 function drawO(color, lineWidth, top, left, width, height) {
 	canvasContext.beginPath();
	canvasContext.strokeStyle = color;
	canvasContext.lineWidth = lineWidth;
	canvasContext.arc(
